...
BOOST_FORCEINLINE
bool
write_impl(boolean_category, writer& w, stream& ss)
{
    BOOST_ASSERT( w.p_ );
...
BOOST_FORCEINLINE
bool
write_impl(integer_category, writer& w, stream& ss0)
{
#if defined(_MSC_VER)
# pragma warning( push )
# pragma warning( disable : 4127 )
...
BOOST_FORCEINLINE
bool
write_impl(floating_point_category, writer& w, stream& ss0)
{
#if defined(_MSC_VER)
# pragma warning( push )
# pragma warning( disable : 4127 )
...
write_impl(writer& w, stream& ss)
{
    using cat = get_conversion_category<
        T, void, direct_custom_checks, direct_fallback_checks>;
