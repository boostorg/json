...
struct impl : private FloatTraits, private FloatTraits::format
{
    ...
    BOOST_JSON_SAFEBUFFERS static ReturnType compute_nearest_normal(carrier_uint const two_fc, const int exponent,
    ...
    template <typename ReturnType, typename IntervalType, typename TrailingZeroPolicy,
              typename BinaryToDecimalRoundingPolicy, typename CachePolicy, typename... AdditionalArgs>
    BOOST_JSON_SAFEBUFFERS static ReturnType compute_nearest_shorter(const int exponent, AdditionalArgs... additional_args) noexcept
    {
        ReturnType ret_value = {};
        IntervalType interval_type{additional_args...};
    ...
    BOOST_JSON_SAFEBUFFERS static ReturnType compute_left_closed_directed(carrier_uint const two_fc, int exponent) noexcept
    {
        //////////////////////////////////////////////////////////////////////
        // Step 1: Schubfach multiplier calculation
        //////////////////////////////////////////////////////////////////////
    ...
    BOOST_JSON_SAFEBUFFERS static ReturnType compute_right_closed_directed(carrier_uint const two_fc, const int exponent, bool shorter_interval) noexcept
    {
        //////////////////////////////////////////////////////////////////////
        // Step 1: Schubfach multiplier calculation
        //////////////////////////////////////////////////////////////////////
...
template <typename Float, typename FloatTraits = dragonbox_float_traits<Float>>
BOOST_FORCEINLINE BOOST_JSON_SAFEBUFFERS auto
...
std::size_t dragon_box_print_chars(
    dragonbox_float_traits<double>::carrier_uint significand,
    int exponent,
    char* first,
    char* last) noexcept;
